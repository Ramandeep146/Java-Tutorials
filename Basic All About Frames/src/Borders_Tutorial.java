...
public class Borders_Tutorial {
	...
	public static void main(String[] args) {
		...
		frame.setLayout(new BorderLayout(10,10)); // you can also pass values to setup the margin (width,height)
		...
		panel5.setLayout(new BorderLayout()); // panel 5 is acting as a new container
